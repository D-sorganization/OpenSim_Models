...
### Performance
- Optimized precondition check hot-paths (`require_shape`, `require_finite`, `require_unit_vector`) by replacing `type(x) is` with `x.__class__ is`, avoiding Python function call overhead.
