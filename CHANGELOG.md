...
### Performance
- Optimized ElementTree operations by replacing `.find()` with direct child iteration in multiple hot paths (postconditions, coordinate defaults, contact helpers, bench press builder), achieving 2-3x speedups for these lookups.
