...
### Performance
- Optimized XML shallow lookups by replacing `Element.find()` with direct child iteration (`for child in parent:`) in postconditions and joints generation, providing a significant speedup by avoiding ElementPath regex parsing.
