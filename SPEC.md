...
| Date       | Version | Notes                                                                                                                                                                                                                                                        |
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-07-20 | 1.0.21  | Replaced `xml.etree.ElementTree.find()` with direct child iteration in OpenSim model generation code paths to eliminate ElementPath regex parsing overhead, resulting in 2-3x faster child lookups.                                                          |
