...
| Date       | Version | Notes                                                                                                                                                                                                                                                        |
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-06-25 | 0.1.3   | Optimized precondition check hot-paths (`require_shape`, `require_finite`, `require_unit_vector`) by replacing `type(x) is` with `x.__class__ is`, avoiding python function call overhead. |
