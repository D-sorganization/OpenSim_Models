...
| Date       | Version | Notes                                                                                                                                                                                                                                                        |
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-07-14 | 1.0.20  | Optimized precondition check hot-paths (`require_finite`, `require_shape`) by replacing `type(arr)` with `arr.__class__` to bypass function overhead and utilizing native tuple equality `expected == (3,)` over list element extractions.                 |
