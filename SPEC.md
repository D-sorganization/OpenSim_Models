...
| Date       | Version | Notes                                                                                                                                                                                                                                                        |
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-07-20 | 1.0.20  | Optimized `require_finite` validation function in `preconditions.py` by adding a fast path for shape-6 numpy arrays using `.item()` to manually unroll checks, resulting in a ~1.8x speedup for 6-DOF arrays.                                                |
